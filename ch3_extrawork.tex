...
\caption{\label{fig:edits} Examples of edits that can be made to highlight features in images of capillaries. The left image has had the contrast increased, the center image has also been run through a bandpass filter, and the right image has additionally had objects enhanced via the Maximum filter.}
\end{center}
\end{figure*}
