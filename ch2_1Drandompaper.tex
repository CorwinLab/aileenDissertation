...
Our world is fueled by outliers. Information in signals is carried by the leading edge \cite{saxton_single-particle_1997,pinto_physics_2000, hofling_anomalous_2013, ghosh_non-universal_2015, manzo_review_2015, iyer-biswas_first_2016,metzler_non-brownian_2016,  shen_single_2017}.
...
The random walk in random environment (RWRE) model goes back to~\cite{chernov_replication_1967, temkin_one-dimensional_1972} (see also~\cite{havlin_diffusion_1987, bolthausen_ten_2002,sznitman_topics_2004, ofer_random_2004, hughes_random_1995}) and comes in two types -- long-range~\cite{kesten_limit_1975,sinai_limiting_1983,bouchaud_classical_1990, bouchaud_anomalous_1990, burlatsky_transient_1998, le_doussal_random_1999} and short-range~\cite{richardson_atmospheric_1926, hentschel_relative_1984, bouchaud_diffusion_1990,  chertkov_anomalous_1996, bernard_anomalous_1996, jullien_richardson_1999, balkovsky_intermittent_2001} temporally correlated environments. We focus here on the latter. In this context, typical RWRE particles behave like Brownian motion, matching the behavior from Einstein's model~\cite{rassoul-agha_almost_2005, deuschel_quenched_2016}.
...
Using Eq. \eqref{eq:maxpb} and Taylor expansion of the results of \cite{barraquand_random-walk_2017} and \cite{barraquand_moderate_2020} quoted above, \cite{SeeSupplementalMaterial} shows that for $t/\log(N)=\hat{t}>1$ the sample fluctuation $\snt$ is of Gumbel type with variance
%
